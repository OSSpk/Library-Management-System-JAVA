...
{    
   ...
   public Borrower(int borrowerId, String borrowerName, String borrowerAddress, int borrowerPhoneNum) {
       super(borrowerId, borrowerName, borrowerAddress, borrowerPhoneNum);
